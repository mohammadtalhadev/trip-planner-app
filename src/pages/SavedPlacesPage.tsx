        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredPlaces.map((place) => {
            ...
            return (
              <div
                key={place.id}
                className="group bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl overflow-hidden shadow-subtle hover:shadow-frost transition-all duration-300 flex flex-col justify-between"
              >
                <div>
                  <div className="relative h-48 w-full overflow-hidden bg-slate-100 dark:bg-slate-800">
                    ...
                    <div className="absolute top-3 left-3">
                      <span className="px-2.5 py-0.5 rounded-full bg-slate-950/60 backdrop-blur-md text-[10px] font-mono uppercase tracking-wider text-slate-200 border border-white/10">
                        {place.category}
                      </span>
                    </div>
                    ...
                    <button
                      ...
                      className="absolute top-3 right-3 p-2 rounded-xl bg-slate-950/50 text-slate-300 hover:bg-rose-600 hover:text-white backdrop-blur-md transition-colors border border-white/10"
                ...
                <div className="p-4 pt-0">
                  <Link
                    to={destinationLink}
                    className="w-full py-2.5 px-3 flex items-center justify-center gap-1.5 rounded-xl bg-slate-100 hover:bg-[#c2410c] hover:text-white dark:bg-slate-800 dark:hover:bg-[#c2410c] dark:hover:text-white text-xs font-bold uppercase tracking-wider text-slate-700 dark:text-slate-300 transition-colors"
                  >
